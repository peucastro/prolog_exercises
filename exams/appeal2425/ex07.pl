...
/*
Implement country_authors(?Country, ?Authors), which unifies Country with a country of birth from the knowledge base and Authors with the list of all authors who were born in that country. Example:
